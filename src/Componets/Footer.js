    ...
    return(
        <>
            ...
            <footer className='footer'
                    style={{display:'flex', flexDirection:'column', height:'60px', margin:'0 ', backgroundColor:'rgb(243, 240, 240)'}}>
                 
                <div className='container-footer'
                     style={{padding:'0',margin:'0'}}>
                     
                    <Link to='https://www.ycombinator.com/apply/' target='_blank'
                     style={{display:'flex', justifyContent:'center', textDecoration:'none', padding:'10px', color:'black', margin:'0'}}
                    ...
                    <div className='links-footer' style={{display:'flex', justifyContent:'center',  margin:'0'}}>
                        <Link to='https://news.ycombinator.com/newsguidelines.html' target='_blank'
                              style={{display:'flex',gap:'15px', justifyContent:'center',  textDecoration:'none', color:'black',margin:'0'}}
                        >Guidelines  |</Link>
